...
export const getPossibleMoves = (elements: IChessBoardElement[][], row: number, column: number, currentPlayer: ChessPieceTeam, element: IChessBoardElement): IChessPieceMovement[] => {
